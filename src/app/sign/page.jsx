...
const AuthPage = () => {
  ...
  const handleForgotPassword = async () => {
   ...
   return ( <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#E0F7FA] via-[#B2DFDB] to-[#edfffd] p-6">
      <div className="relative w-full max-w-4xl h-[600px] bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        >
          <form onSubmit={handleSignIn} className="flex flex-col items-center w-full max-w-sm">
            <h1 className="text-3xl font-bold mb-8  from-[#5D3A1A] via-[#4E2C0A] to-[#3B1F0A]">Sign In</h1>
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-gradient-to-r from-[#5D3A1A] via-[#4E2C0A] to-[#3B1F0A] text-white px-12 py-3 rounded-lg uppercase font-semibold tracking-wide transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50"
            >
        ...
        {/* Toggle Panel */}
        <div
          className={`absolute top-0 left-1/2 w-1/2 h-full bg-gradient-to-br from-[#5D3A1A] via-[#4E2C0A] to-[#3B1F0A] text-white flex transition-all duration-700 ease-in-out ${
            ...
            {isSignUp ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="border-2 border-white hover:bg-white hover:text-[#5D3A1A] text-white px-10 py-3 rounded-lg uppercase font-semibold tracking-wide mt-6 transition-all duration-200"
                >
                  Sign In
                </button>
              </div>
