      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Working together with conservation groups, government bodies, and research institutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
            {[
              ...
              <div key={index} className="bg-white rounded-lg p-6 flex items-center justify-center h-24 shadow-sm hover:shadow-md transition-shadow">
                <span className="text-gray-600 font-semibold text-center text-sm">{partner}</span>
              </div>
            ))}
          </div>
        </div>
